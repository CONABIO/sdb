...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	'columns' => array(
		...
		array(
			...
			'name' => 'sector',
			'value' =>
			'Semana::sector($data->sector)',
			'filter' => Semana::sector(),
			'sortable' => false,
		),
		array(
		...
		array(
			...
			'name' => 'publico_meta',
			'value' =>
			'Semana::publico_meta($data->publico_meta)',
			'filter' => Semana::publico_meta(),
			'sortable' => false,
		),
		array(
			'type' => 'raw',
		...
		array(
			'type' => 'raw',
			'name' => 'formato_actividad',
			'value' =>
			'Semana::formato_actividad($data->formato_actividad)',
			'filter' => Semana::formato_actividad(),
			'sortable' => false,
		),
		array(
