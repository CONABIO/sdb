...
<?php $this->widget('zii.widgets.CDetailView', array(
	...
	'attributes' => array(
		...
		array(
			'name' => 'sector',
			'value' => Semana::sector($model->sector),
		),
		array(
			'name' => 'publico_meta',
			'value' => Semana::publico_meta($model->publico_meta),
		),
		array(
			'name' => 'estado_id',
		...
		array(
			...
			'value' => Semana::formato_actividad($model->formato_actividad),
		),
		'direccion',
		array(
			'name' => 'fecha_ini',
